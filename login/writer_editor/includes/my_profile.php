                                 ...
                                 <div class="active tab-pane" id="settings">
                                     <form class="form-horizontal" method="POST">
                                         ...
                                         <div class="form-group row">
                                             ...
                                             <div class="col-sm-10">
                                                 <input type="password" class="form-control" name="user_password" id="inputName2" placeholder="Password" onClick="this.setSelectionRange(0, this.value.length)" required>
