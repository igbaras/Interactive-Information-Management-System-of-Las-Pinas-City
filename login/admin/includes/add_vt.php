        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header bg-info">
                    <h2 class="card-title"> <a class="btn btn-warning" href="./virtualTour.php"><i class="fas fa-arrow-left"></i> BACK</a> Add Virtual Spots to <strong><?php echo $vt_title; ?></strong></h2>
                </div>
                <!-- /.card-header -->
                <!-- ADD ITEM BUTTON -->
