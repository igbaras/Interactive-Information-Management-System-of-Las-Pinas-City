...
if (isset($_POST['submit_sign'])) {
  ...
  if ($username1 == $username) {
    ...
    if ($user_password == $cuser_password) {
      $hash = password_hash($user_password, PASSWORD_DEFAULT);
      $sql = "INSERT INTO public_users (username, user_fname, user_lname, user_avatar, user_email, user_password, joinDate) VALUES ('$username', '$user_fname', '$user_lname', 'https://res.cloudinary.com/sarabgi/image/upload/v1688562896/index/user-default_iexspt.png', '$user_email', '$hash', current_timestamp())";
      $result = mysqli_query($connection, $sql);
      if ($result) {
        $showAlert = true;
    ...
    <div class="modal-content" style=" background: #DADFD9;  color: #00180A;">
      ...
      <div class="modal-body">
        <form action="" method="post">
          ...
          <button type="submit" name="submit_sign" class="btn btn-warning">Submit</button>
        </form>
