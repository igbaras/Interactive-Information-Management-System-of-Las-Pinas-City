      ...
      <div class="modal-body">
        <form action="public_users/_handleLogin.php" method="post">
          ...
          <div class="text-left my-2">
            ...
            <input class="form-control border-secondary" id="loginpassword" name="loginpassword" placeholder="Enter Your Password" type="password" required data-toggle="password">
          </div>
